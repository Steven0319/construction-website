        ...
        <SwiperSlide>
            <div className="px-12 md:pl-[60px] flex items-center gap-9 h-full">
                ...
                <div className="relative hidden xl:flex w-[90px] h-[90px]">
                    <Image src="/assets/img/testimonials/avatar.jpg" fill className="object-contain" quality={100} alt=""/>
                </div>
                {/*text*/}
                <div className="flex-1 xl:max-w-[340px] flex flex-col gap-2">
                    <p>
                        Exceeded expectations. On time, within budget and
                        top quality work. High recommend!
                    </p>
